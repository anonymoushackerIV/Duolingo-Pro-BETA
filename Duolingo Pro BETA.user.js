...
if (!isNaN(Number(localStorage.getItem('duopro.forever.totalXPs'))) && Number(localStorage.getItem('duopro.forever.totalXPs')) !== null) {
    duoproForeverTotalXPs = Number(localStorage.getItem('duopro.forever.totalXPs'));
} else {
    duoproForeverTotalXPs = 0;
    localStorage.setItem('duopro.forever.totalXPs', duoproForeverTotalXPs);
}

let duoproSessionXPs = 0;
if (!isNaN(Number(localStorage.getItem('duopro.session.totalXPs'))) && Number(localStorage.getItem('duopro.session.totalXPs')) !== null) {
    duoproSessionXPs = Number(localStorage.getItem('duopro.session.totalXPs'));
} else {
    duoproSessionXPs = 0;
    localStorage.setItem('duopro.session.totalXPs', duoproSessionXPs);
}
...
let autoSolverBoxStoryOnlyMode;
...
if (JSON.parse(sessionStorage.getItem('autoSolverBoxLegendaryOnlyMode')) == null) {
    autoSolverBoxLegendaryOnlyMode = true;
} else {
    autoSolverBoxLegendaryOnlyMode = JSON.parse(sessionStorage.getItem('autoSolverBoxLegendaryOnlyMode'));
}
if (JSON.parse(sessionStorage.getItem('autoSolverBoxStoryOnlyMode')) == null) {
    autoSolverBoxStoryOnlyMode = true;
} else {
    autoSolverBoxStoryOnlyMode = JSON.parse(sessionStorage.getItem('autoSolverBoxStoryOnlyMode'));
}
...
let AutoSolverSettingsShowStoryOnlyModeForAutoSolverBox = true;
//moved here
    ...
    <div class="AutoSolverBoxBackground">
        <div class="AutoSolverBoxLayers">
            ...
            <div class="AutoSolverBoxSectionThreeBox">
                ...
                <div class="AutoSolverBoxSectionThreeBoxSectionTwo" id="AutoSolverBoxSectionThreeBoxSectionTwoIDFour">
                    <div class="AutoSolverBoxSectionThreeBoxSectionTwoTextOne">Legendary Path Farm</div>
                    <div id="AutoSolverBoxToggleT1ID4" class="DLPSettingsToggleT1 DLPSettingsToggleT1ON">
                        <div class="DLPSettingsToggleT1B1 DLPSettingsToggleT1ONB1">
                            <svg class="DLPSettingsToggleT1B1I1" style="display: ;" "16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.41406 13.9453C5.91406 13.9453 5.53906 13.7656 5.20312 13.3672L1.17188 8.48438C0.890625 8.16406 0.789062 7.875 0.789062 7.54688C0.789062 6.8125 1.33594 6.27344 2.09375 6.27344C2.53125 6.27344 2.84375 6.42969 3.13281 6.77344L6.375 10.7969L12.7656 0.71875C13.0781 0.226562 13.3984 0.0390625 13.9141 0.0390625C14.6641 0.0390625 15.2109 0.570312 15.2109 1.30469C15.2109 1.57812 15.125 1.86719 14.9219 2.17969L7.64062 13.3125C7.35938 13.7422 6.94531 13.9453 6.41406 13.9453Z" fill="white"/>
                            </svg>
                ...
                <div class="AutoSolverBoxSectionThreeBoxSectionTwo" id="AutoSolverBoxSectionThreeBoxSectionTwoIDFive">
                    <div class="AutoSolverBoxSectionThreeBoxSectionTwoTextOne">Story Path Farm</div>
                    <div id="AutoSolverBoxToggleT1ID5" class="DLPSettingsToggleT1 DLPSettingsToggleT1ON">
                        <div class="DLPSettingsToggleT1B1 DLPSettingsToggleT1ONB1">
                            <svg class="DLPSettingsToggleT1B1I1" style="display: ;" "16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.41406 13.9453C5.91406 13.9453 5.53906 13.7656 5.20312 13.3672L1.17188 8.48438C0.890625 8.16406 0.789062 7.875 0.789062 7.54688C0.789062 6.8125 1.33594 6.27344 2.09375 6.27344C2.53125 6.27344 2.84375 6.42969 3.13281 6.77344L6.375 10.7969L12.7656 0.71875C13.0781 0.226562 13.3984 0.0390625 13.9141 0.0390625C14.6641 0.0390625 15.2109 0.570312 15.2109 1.30469C15.2109 1.57812 15.125 1.86719 14.9219 2.17969L7.64062 13.3125C7.35938 13.7422 6.94531 13.9453 6.41406 13.9453Z" fill="white"/>
                            </svg>
    ...
    if (window.location.pathname === '/learn') {
        if (!injectedContainer) {
            ...
            try {
                ...
                let AutoSolverBoxSectionThreeBoxSectionTwoIDFourForHiding = document.querySelector('#AutoSolverBoxSectionThreeBoxSectionTwoIDFour');
                let AutoSolverBoxSectionThreeBoxSectionTwoIDFiveForHiding = document.querySelector('#AutoSolverBoxSectionThreeBoxSectionTwoIDFive');
                ...
                if (AutoSolverSettingsShowAutoSolverBox) {
                    ...
                    if (!AutoSolverSettingsShowLegendaryOnlyModeForAutoSolverBox) {
                        AutoSolverBoxSectionThreeBoxSectionTwoIDFourForHiding.remove();
                    }
                    if (!AutoSolverSettingsShowStoryOnlyModeForAutoSolverBox) {
                        AutoSolverBoxSectionThreeBoxSectionTwoIDFiveForHiding.remove();
                    }
                } else {
                    console.log('error 5');
                }
...
function initializeAutoSolverBoxButtonInteractiveness() {
    ...
    try {
        ...
        const AutoSolverBoxToggleT1ID4 = document.querySelector('#AutoSolverBoxToggleT1ID4');
        const AutoSolverBoxToggleT1ID5 = document.querySelector('#AutoSolverBoxToggleT1ID5');
        ...
        AutoSolverBoxToggleT1ID1.addEventListener('click', () => {
            if (autoSolverBoxPracticeOnlyMode) {
                ...
                autoSolverBoxLegendaryOnlyMode = !autoSolverBoxPracticeOnlyMode;
                autoSolverBoxStoryOnlyMode = !autoSolverBoxPracticeOnlyMode;
                sessionStorage.setItem('autoSolverBoxPracticeOnlyMode', autoSolverBoxPracticeOnlyMode);
                ...
                sessionStorage.setItem('autoSolverBoxLegendaryOnlyMode', autoSolverBoxLegendaryOnlyMode);
                sessionStorage.setItem('autoSolverBoxStoryOnlyMode', autoSolverBoxStoryOnlyMode);
                updateAutoSolverToggles(AutoSolverBoxToggleT1ID1, autoSolverBoxPracticeOnlyMode);
                ...
                updateAutoSolverToggles(AutoSolverBoxToggleT1ID4, autoSolverBoxLegendaryOnlyMode);
                updateAutoSolverToggles(AutoSolverBoxToggleT1ID5, autoSolverBoxStoryOnlyMode);
            }
        });
        ...
        AutoSolverBoxToggleT1ID2.addEventListener('click', () => {
            if (autoSolverBoxRepeatLessonMode) {
                ...
                autoSolverBoxLegendaryOnlyMode = !autoSolverBoxRepeatLessonMode;
                autoSolverBoxStoryOnlyMode = !autoSolverBoxRepeatLessonMode;
                sessionStorage.setItem('autoSolverBoxPracticeOnlyMode', autoSolverBoxPracticeOnlyMode);
                sessionStorage.setItem('autoSolverBoxRepeatLessonMode', autoSolverBoxRepeatLessonMode);
                sessionStorage.setItem('autoSolverBoxListeningOnlyMode', autoSolverBoxListeningOnlyMode);
                sessionStorage.setItem('autoSolverBoxLegendaryOnlyMode', autoSolverBoxLegendaryOnlyMode);
        ...
        AutoSolverBoxToggleT1ID3.addEventListener('click', () => {
            if (autoSolverBoxListeningOnlyMode) {
                ...
                autoSolverBoxLegendaryOnlyMode = !autoSolverBoxListeningOnlyMode;
                autoSolverBoxStoryOnlyMode = !autoSolverBoxListeningOnlyMode;
                sessionStorage.setItem('autoSolverBoxPracticeOnlyMode', autoSolverBoxPracticeOnlyMode);
                sessionStorage.setItem('autoSolverBoxRepeatLessonMode', autoSolverBoxRepeatLessonMode);
                sessionStorage.setItem('autoSolverBoxListeningOnlyMode', autoSolverBoxListeningOnlyMode);
                sessionStorage.setItem('autoSolverBoxLegendaryOnlyMode', autoSolverBoxLegendaryOnlyMode);
                ...
                AutoSolverBoxToggleT1ID4.addEventListener('click', () => {
            if (autoSolverBoxLegendaryOnlyMode) {
                autoSolverBoxLegendaryOnlyMode = !autoSolverBoxLegendaryOnlyMode;
                sessionStorage.setItem('autoSolverBoxLegendaryOnlyMode', autoSolverBoxLegendaryOnlyMode);
                updateAutoSolverToggles(AutoSolverBoxToggleT1ID3, autoSolverBoxLegendaryOnlyMode);
            } else {
                autoSolverBoxListeningOnlyMode = !autoSolverBoxLegendaryOnlyMode;
                autoSolverBoxPracticeOnlyMode = !autoSolverBoxLegendaryOnlyMode;
                autoSolverBoxRepeatLessonMode = !autoSolverBoxLegendaryOnlyMode;
                autoSolverBoxLegendaryOnlyMode = !autoSolverBoxLegendaryOnlyMode;
                autoSolverBoxStoryOnlyMode = !autoSolverBoxLegendaryOnlyMode;
                sessionStorage.setItem('autoSolverBoxPracticeOnlyMode', autoSolverBoxPracticeOnlyMode);
                sessionStorage.setItem('autoSolverBoxRepeatLessonMode', autoSolverBoxRepeatLessonMode);
                sessionStorage.setItem('autoSolverBoxListeningOnlyMode', autoSolverBoxListeningOnlyMode);
                sessionStorage.setItem('autoSolverBoxLegendaryOnlyMode', autoSolverBoxLegendaryOnlyMode);
                ...
                AutoSolverBoxToggleT1ID5.addEventListener('click', () => {
            if (autoSolverBoxStoryOnlyMode) {
                autoSolverBoxStoryOnlyMode = !autoSolverBoxStoryOnlyMode;
                sessionStorage.setItem('autoSolverBoxStoryOnlyMode', autoSolverBoxStoryOnlyMode);
                updateAutoSolverToggles(AutoSolverBoxToggleT1ID3, autoSolverBoxStoryOnlyMode);
            } else {
                autoSolverBoxListeningOnlyMode = !autoSolverBoxStoryOnlyMode;
                autoSolverBoxPracticeOnlyMode = !autoSolverBoxStoryOnlyMode;
                autoSolverBoxRepeatLessonMode = !autoSolverBoxStoryOnlyMode;
                autoSolverBoxLegendaryOnlyMode = !autoSolverBoxStoryOnlyMode;
                autoSolverBoxStoryOnlyMode = !autoSolverBoxStoryOnlyMode;
                sessionStorage.setItem('autoSolverBoxPracticeOnlyMode', autoSolverBoxPracticeOnlyMode);
                sessionStorage.setItem('autoSolverBoxRepeatLessonMode', autoSolverBoxRepeatLessonMode);
                sessionStorage.setItem('autoSolverBoxListeningOnlyMode', autoSolverBoxListeningOnlyMode);
...
function XyEOALuaeQicpGHW() {
    if ((DuolingoProSettingsNeverEndMode || autoSolverBoxRepeatAmount > 0) && wasAutoSolverBoxRepeatStartButtonPressed) {
        ...
        } else if (autoSolverBoxLegendaryOnlyMode) {
            window.location.href = "https://duolingo.com/practice-hub/listening-practice";
        } else if (autoSolverBoxStoryOnlyMode) {
            window.location.href = "https://duolingo.com/practice-hub/listening-practice";
        } else {
